...
export default function TextForm(props) {
  ...
  >
    <h1>{props.heading}</h1>
    <div className="mb-3">
    <textarea className="form-control" value={Text} placeholder='Enter text here' onChange={handleOnChange} id="MyTextArea" rows="8" style={{color: props.mode==='dark'?'white':'black',
